...
<body>
    <div id="container">
        <div class="section active" data-anchor="home">
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/1-1.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/1-2.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/1-3.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/1-4.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/1-5.png')}})"></div>
            </div>
        </div>
        <div class="section" data-anchor="aboutcitta1">
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/2-1.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/2-2.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/2-3.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/2-4.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/2-5.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/2-6.png')}})"></div>
            </div>
        </div>
        <div class="section" data-anchor="aboutcitta2">
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/3-1.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/3-2.png')}})"></div>
            </div>
        </div>
        <div class="section" data-anchor="aboutkwah1">
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/4-1.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/4-2.png')}})"></div>
            </div>
            <div class="slide">
                <div class="page" style="background-image: url({{asset('/images/pages/4-3.png')}})"></div>
            </div>
        </div>
        <div class="section" data-anchor="aboutkwah2">
            <div class="page" style="background-image: url({{asset('/images/pages/5-1.png')}})"></div>
        </div>
        <div class="section" data-anchor="aboutkwah3">
            <div class="page" style="background-image: url({{asset('/images/pages/5-2.png')}})"></div>
        </div>
        <div class="section" data-anchor="aboutkwah4">
            <div class="page" style="background-image: url({{asset('/images/pages/5-3.png')}})"></div>
        </div>
        <div class="section" data-anchor="aboutkwah5">
            <div class="page" style="background-image: url({{asset('/images/pages/5-4.png')}})"></div>
        </div>
        <div class="section" data-anchor="contactus">
            <div class="page" style="background-image: url({{asset('/images/pages/6-1.png')}})"></div>
        </div>
    </div>
    <div id="header">
        <div id="logo">
