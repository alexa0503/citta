<div id="menu" class="hidden">
    ...
    <div class="menus">
        <ul id="menus" class="{{App::currentLocale()}}">
            ...
            <li data-menuanchor=""  @class(['active'=>isset($page) && $page === 'projects'])><a href="javascript:void(0);">{{__("精彩项目")}}</a>
                <ul>
                    <li data-menuanchor=""><a href="{{ url('/projects/?lang='.App::currentLocale()) }}">{{__("臻逸恒丰服务式公寓")}}</a></li>
                </ul>
            </li>
