                                        ...
                                        <tr role="row" class="row-check {{ $k%2==1?'odd':'even' }}">
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{ route('cms.settings.edit',$item) }}" class="btn btn-secondary">{{ __('编辑') }}</a>
                                                    <a href="#" data-method="DELETE" data-url="{{ route('cms.settings.destroy',$item) }}" class="btn btn-secondary destroy">{{ __('删除') }}</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
